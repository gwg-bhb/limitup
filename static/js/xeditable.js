    ...
    */
    self.handleEmpty = function() {
      ...
      self.handleRed = function() {
          ...
          $element.toggleClass('editable-red', isRed);  
      };
      self.handleBold = function() {
          var val = valueGetter($scope.$parent);
          var isBold = false;
          if (val !== undefined) {
              val = val.toString();
              isBold = val.indexOf('bold') != -1
          }
          $element.toggleClass('editable-bold', isBold);
      };
